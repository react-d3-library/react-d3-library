(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.reactD3Library = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"d3":21}],2:[function(require,module,exports){
'use strict';
...
function createBarChart(data) {
	...
	svg.selectAll("bar").data(data.dataSet).enter().append("rect").style("fill", function (d) {
...
},{"d3":21}],3:[function(require,module,exports){
'use strict';
...
function createLineChart(data) {
    ...
    data.tsvFileName !== '' ? d3.tsv(data.tsvFileName, lineChartParse, setLineChartData) : data.csvFileName !== '' ? d3.csv(data.csvFileName, lineChartParse, setLineChartData) : setLineChartData(false, data.dataset, data);
...
},{"d3":21}],4:[function(require,module,exports){
'use strict';
...
function createPieChart(data) {
	...
	var svg = d3.select(div).append("svg").attr("width", data.width).attr("height", data.height).append("g").attr("transform", "translate(" + data.width / 2 + "," + data.height / 2 + ")");
...
},{"d3":21}],5:[function(require,module,exports){
'use strict';
...
function createPieChart(data) {
    ...
    var svg = d3.select(div).append("svg").attr("width", width + data.margin.left + data.margin.right).attr("height", height + data.margin.top + data.margin.bottom).append("g").attr("transform", "translate(" + data.margin.left + "," + data.margin.top + ")");
...
},{"./../react-d3/createReactComponents":9,"react":53}],7:[function(require,module,exports){
'use strict';

var React = require('react');
var d3DataToJSX = require('./../react-d3/d3DataToJSX');
var D3ChildContainer = require('./d3ChildContainer');
...
module.exports = React.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    var d3Data = d3DataToJSX(nextProps.data);
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(D3ChildContainer, { data: this.state })
    );
  }
});

},{"./../react-d3/d3DataToJSX":10,"./d3ChildContainer":6,"react":53}],8:[function(require,module,exports){
'use strict';

exports.Component = require('./d3Components/d3StateContainer');
exports.AreaChart = require('./basic-graphs/createAreaChart');
exports.BarChart = require('./basic-graphs/createBarChart');
exports.LineChart = require('./basic-graphs/createLineChart');
exports.PieChart = require('./basic-graphs/createPieChart');
exports.ScatterPlot = require('./basic-graphs/createScatterPlot');

},{"./basic-graphs/createAreaChart":1,"./basic-graphs/createBarChart":2,"./basic-graphs/createLineChart":3,"./basic-graphs/createPieChart":4,"./basic-graphs/createScatterPlot":5,"./d3Components/d3StateContainer":7}],9:[function(require,module,exports){
'use strict';

var extractData = require('./extractData');
var passReactState = require('./passReactState');
...
function makeChildNodes(reactData, stateData) {
  ...
  return reactData.map(function (obj, i) {
    ...
    return obj.children.length === 0 ? React.createElement(obj.tag, passReactState(obj, stateData), obj.props.textContent) : React.createElement(obj.tag, obj.props, extractData(obj.children).mappedData.map(function (obj) {
      return makeChildNodes([obj], stateData);
    }));
  });
}
...
},{"./extractData":11,"./passReactState":15,"react":53}],10:[function(require,module,exports){
'use strict';
...
var getRawData = function getRawData(node) {
...
},{"./extractData":11,"react":53}],11:[function(require,module,exports){
'use strict';

var getStyles = require('./getStyles');
var getAttributes = require('./getAttributes');
var applyD3ReactId = require('./../utils/applyD3ReactId');
...
},{"./../utils/applyD3ReactId":16,"./getAttributes":12,"./getStyles":13}],12:[function(require,module,exports){
'use strict';

var eventHandler = require('./parseEventHandler');
...
module.exports = function (attributesObject, node) {
  ...
  var eventHandlers = eventHandler(node);

  for (var _key in eventHandlers) {
    if (_key !== 'undefined') attributes[_key] = eventHandlers[_key];
  }
...
},{"./../utils/toCamelCase":20,"./parseEventHandler":14}],13:[function(require,module,exports){
'use strict';
...
module.exports = function (styleObject) {
	...
	if (typeof styleObject === 'string') {
		...
		styleArray.forEach(function (style) {
			var isDash = style.indexOf('-');
			var indexOfColon = style.indexOf(':');

			var key = isDash > -1 ? style.slice(0, isDash) + style.slice(isDash + 1, isDash + 2).toUpperCase() + style.slice(isDash + 2, indexOfColon) : style.slice(0, indexOfColon);

			var isNum = style.slice(indexOfColon + 1);
			var value = isNaN(isNum) ? isNum.trim() : Number(isNum);
...
var parseD3Function = require('./../utils/parseD3Function');
var parseD3Event = require('./../utils/parseD3Event');

module.exports = function (node) {
  var eventHandlers = {};
  for (var key in node) {
    if (key.indexOf('__') > -1 && key.indexOf('data') < 0) {
      var stringifiedFunction = String(node[key]['_']);
      var parsedD3Function = parseD3Function(stringifiedFunction);
...
},{"./../utils/parseD3Event":17,"./../utils/parseD3Function":18}],15:[function(require,module,exports){
'use strict';

module.exports = function (obj, stateData) {
...
function applyD3ReactId(children, counter) {
  ...
  function apply(parent) {
    ...
    parent.forEach(function (child, i) {
      ...
      child['__data__'] ? result.state[child.localName + '.' + counter + '.' + parentCount + '.' + count] = child['__data__'] : result.state[child.localName + '.' + counter + '.' + parentCount + '.' + count] = null;
...
module.exports = function (event) {
  ...
  }, _defineProperty(_reactEvents, '__onmouseover', 'onMouseOver'), _defineProperty(_reactEvents, '__onmouseup', 'onMouseUp'), _reactEvents);
...
var stringToFunction = require('./stringToFunction');

//Takes function string
module.exports = function (func) {
  //Parses string and returns new function
  return stringToFunction(func.substring(func.indexOf("{") + 1, func.lastIndexOf("}")).replace(/^[ \s]+|[ \s]+$/gi, ''));
};

},{"./stringToFunction":19}],19:[function(require,module,exports){
'use strict';
...
},{"./invariant":24,"_process":30}],26:[function(require,module,exports){
"use strict";
...
},{"./emptyFunction":22,"_process":30}],29:[function(require,module,exports){
'use strict';
...
},{"_process":30,"fbjs/lib/invariant":24}],33:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactChildren":34,"./ReactClass":35,"./ReactComponent":36,"./ReactDOMFactories":38,"./ReactElement":40,"./ReactElementValidator":41,"./ReactPropTypes":47,"./ReactVersion":48,"./onlyChild":51,"_process":30,"fbjs/lib/warning":28,"object-assign":29}],34:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":32,"./ReactElement":40,"./traverseAllChildren":52,"fbjs/lib/emptyFunction":22}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactComponent":36,"./ReactElement":40,"./ReactNoopUpdateQueue":44,"./ReactPropTypeLocationNames":45,"./ReactPropTypeLocations":46,"_process":30,"fbjs/lib/emptyObject":23,"fbjs/lib/invariant":24,"fbjs/lib/keyMirror":25,"fbjs/lib/keyOf":26,"fbjs/lib/warning":28,"object-assign":29}],36:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactInstrumentation":42,"./ReactNoopUpdateQueue":44,"./canDefineProperty":49,"_process":30,"fbjs/lib/emptyObject":23,"fbjs/lib/invariant":24,"fbjs/lib/warning":28}],37:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":40,"./ReactElementValidator":41,"_process":30,"fbjs/lib/mapObject":27}],39:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactInvalidSetStateWarningDevTool":43,"_process":30,"fbjs/lib/warning":28}],40:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactCurrentOwner":37,"./canDefineProperty":49,"_process":30,"fbjs/lib/warning":28,"object-assign":29}],41:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":37,"./ReactElement":40,"./ReactPropTypeLocationNames":45,"./ReactPropTypeLocations":46,"./canDefineProperty":49,"./getIteratorFn":50,"_process":30,"fbjs/lib/invariant":24,"fbjs/lib/warning":28}],42:[function(require,module,exports){
/**
 * Copyright 2016-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDebugTool":39}],43:[function(require,module,exports){
(function (process){
/**
 * Copyright 2016-present, Facebook, Inc.
 * All rights reserved.
...
},{"_process":30,"fbjs/lib/warning":28}],44:[function(require,module,exports){
(function (process){
/**
...
},{"_process":30,"fbjs/lib/warning":28}],45:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"fbjs/lib/keyMirror":25}],47:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":40,"./ReactPropTypeLocationNames":45,"./getIteratorFn":50,"fbjs/lib/emptyFunction":22}],48:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":30}],50:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":40,"_process":30,"fbjs/lib/invariant":24}],52:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./KeyEscapeUtils":31,"./ReactCurrentOwner":37,"./ReactElement":40,"./getIteratorFn":50,"_process":30,"fbjs/lib/invariant":24,"fbjs/lib/warning":28}],53:[function(require,module,exports){
'use strict';
