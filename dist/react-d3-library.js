...
module.exports = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(ChildComponent, { data: this.state })
    );
  }
});

},{"./../react-d3/d3DataToJSX":10,"./ChildComponent":6,"react":53}],8:[function(require,module,exports){
'use strict';

exports.Component = require('./d3Components/Component');
exports.AreaChart = require('./charts/createAreaChart');
exports.BarChart = require('./charts/createBarChart');
exports.LineChart = require('./charts/createLineChart');
exports.PieChart = require('./charts/createPieChart');
exports.ScatterPlot = require('./charts/createScatterPlot');

},{"./charts/createAreaChart":1,"./charts/createBarChart":2,"./charts/createLineChart":3,"./charts/createPieChart":4,"./charts/createScatterPlot":5,"./d3Components/Component":7}],9:[function(require,module,exports){
'use strict';
